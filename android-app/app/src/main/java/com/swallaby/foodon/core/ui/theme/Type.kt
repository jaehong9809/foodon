...
val Typography = Typography(
    ...
    bodySmall = NotoTypography.NotoNormal12,

    labelLarge = NotoTypography.NotoNormal16,
    labelMedium = NotoTypography.NotoNormal14,
    labelSmall = NotoTypography.NotoNormal12
)